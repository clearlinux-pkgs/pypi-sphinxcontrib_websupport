...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695156932
...
cp %{_builddir}/sphinxcontrib-websupport-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_websupport/e5d1b0fd46b681f4be3ce69e064b9427372ea1f2 || :
